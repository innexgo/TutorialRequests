...
public enum Errors {
  ...
  VERIFICATION_KEY_NONEXISTENT(HttpStatus.BAD_REQUEST),
  VERIFICATION_KEY_INVALID(HttpStatus.BAD_REQUEST),
  VERIFICATION_KEY_TIMED_OUT(HttpStatus.BAD_REQUEST),
  ACCESS_KEY_NONEXISTENT(HttpStatus.BAD_REQUEST),
  ACCESS_KEY_INVALID(HttpStatus.BAD_REQUEST),
  ACCESS_KEY_TIMED_OUT(HttpStatus.BAD_REQUEST),
