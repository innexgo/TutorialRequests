...
public enum Errors {
  ...
  APPT_REQUEST_NONEXISTENT("the appointment request you are trying to perform this operation on does not exist", HttpStatus.BAD_REQUEST),
  ...
  INVALID_ATTENDANCE_STATUS_KIND("the attendance status provided is not one of \"PRESENT\",  \"TARDY\", or \"ABSENT\"", HttpStatus.BAD_REQUEST),
